...
const HomeScreen = () => {
	...
	const baseUrl = "https://quick-stream.web.app/watch";
				...
				<div className="relative container mx-auto px-4 py-16 flex flex-col items-center">
					<div className="text-center space-y-6 max-w-3xl mx-auto mb-16">
						...
						<p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
							Connect with your friends and fans without the hassles of special
							software and signups. The stress-free way to watch your favorite
